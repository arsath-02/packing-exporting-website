    ...
    <div className="sticky top-0 z-50 p-3 m-4 rounded-md bg-gray-800 text-white">
      <div className="flex justify-between items-center h-16 max-w-[1240px] mx-auto px-4">
        ...
        <ul className="hidden md:flex space-x-6">
            <li><Link to="/Packing/approved" className="hover:text-gray-400">Approved Orders</Link></li>
            <li><Link to="/Packing/history" className="hover:text-gray-400">Packing History</Link></li>
      ...
      >
        ...
        <ul className="flex flex-col p-4 space-y-4 text-white">
            <li><Link to="/Packing/approved" onClick={handleNav} className="hover:text-gray-400">Approved Orders</Link></li>
            <li><Link to="/Packing/history" onClick={handleNav} className="hover:text-gray-400">Packing History</Link></li>
