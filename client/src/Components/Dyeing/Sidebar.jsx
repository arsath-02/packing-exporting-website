...
const Sidebar = () => {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: <FaBoxOpen />, path: '/Dyeing/dashboard' },
    { name: 'Dyeing Task', icon: <FaShoppingCart />, path: '/Dyeing/dyeing-task' },
    { name: 'Team Management', icon: <FaClipboardList />, path: '/Dyeing/team-manage' },
  ];
