...
const ProductionMembers = teamMembers.filter((m) => m.Dept === "Production");
  ...
  <div className="bg-zinc-900 p-4 rounded shadow">
    ...
    <p className="text-xl font-bold">{ProductionMembers.length}</p>
     <p className="text-gray-400">Size of the Production team</p>
  </div>
  <div className="bg-zinc-900 p-4 rounded shadow">
    <p className="text-gray-400">Active</p>
    <p className="text-xl font-bold">
      {ProductionMembers.filter((m) => m.Status === "Active").length}
    </p>
  ...
  <div className="bg-zinc-900 p-4 rounded shadow">
    ...
    <p className="text-xl font-bold">
      {ProductionMembers.filter((m) => m.Status === "In-Active").length}
    </p>
    <p className="text-gray-400">Number of In-Active Employees</p>
        ...
        <section className="bg-zinc-900 p-6 rounded shadow">
          <h2 className="text-2xl font-semibold mb-4">Production Team Members</h2>
          <table className="w-full text-left text-sm">
           ...
           <tbody>
            {teamMembers
              .filter((member) => member.Dept === 'Production')
              .map((member, idx) => (
